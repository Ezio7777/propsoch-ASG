    ...
    <section id="resources" aria-labelledby="resources-heading" className="bg-gray-50/70 py-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
          {blogPosts.map((post) => (
            <article key={post.slug} className="bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-lg hover:-translate-y-1 transition-all duration-200 group">
              ...
              <div className="p-5">
                <span className="text-orange-700 text-xs font-semibold uppercase tracking-wide">
                  {post.category}
                </span>
        ...
        {/* Hometrust community CTA */}
        <div className="bg-gradient-to-br from-orange-50 via-amber-50 to-orange-100/50 rounded-3xl p-10 text-center border border-orange-100">
          <p className="text-purple-700 text-sm font-semibold mb-2 tracking-wide uppercase">
            Community
          </p>
